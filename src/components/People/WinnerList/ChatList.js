...
//  const {show ,onHide} = props;
  ...
  render() {
    return (
      <>{this.props.show&&(<div className="main__chatlist"style={{width:'300px'}} >
        <button className="btn hover:bg-red-300" >
          <i className="fa fa-plus"></i>
          <span>Random Match</span>
        </button>
        <div className="chatlist__heading">
          <h1>Top Rankers of Week</h1>
          <button className="search-btn">
          <i class="fa fa-arrow-left fa-1x m-2" onClick={()=>{this.props.onHide()}}></i>
          </button>
        </div>
